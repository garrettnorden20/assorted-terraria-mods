...
namespace BasicMod.Projectiles.TeslaProjs
{
	...
	class TeslaLine : ModProjectile
	{
		...
		public override void AI()
		{
            ...
            {
				start = projectile.position + new Vector2(0, -1.5f * Main.screenHeight); // wherever intiially spawned, plsu higher to disguise oepning
				end = projectile.position + new Vector2(0, 1.5f * Main.screenHeight); // down below start
