...
{
    public class SwatCopter : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("SwatCopter");
    ...
    public class SwatBomb : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("SwatBomb");
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(projectile.Center, new Vector2(0, 0), mod.ProjectileType("SwatBombExplosion"), projectile.damage, projectile.knockBack, player.whoAmI);
            ...
            // Spawn NPC
            //NPC.NewNPC((int)projectile.Center.X, (int)projectile.Center.Y, NPCID.GreekSkeleton);
        }
    }

    public class SwatBombExplosion : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Swat Bomb Explosion");
        }
