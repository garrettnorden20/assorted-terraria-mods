...
namespace BasicMod.Dusts
{
	...
	internal class OutSpiralDust : ModDust
	{
		/*
		...
		*/
		...
		public override bool Update(Dust dust)
		{
			...
			if (dust.customData != null && dust.customData is Player player)
			{
				...
				dust.position = player.Center + Vector2.UnitX.RotatedBy(dust.rotation, Vector2.Zero) * (dust.scale * dust.scale) * 16;
			}
