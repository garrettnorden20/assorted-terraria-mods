...
{
	public class BurningPresence : ModItem
	{
		public override string Texture => "Terraria/Item_" + ItemID.MagmaStone;
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("You feel a burning aura around you..." +
				"\nCauses nearby enemies to be set alight.");
		}
		...
		{
			SetAlight(player.Center);

		}

		public void SetAlight(Vector2 pos) // avoid is one you already hit
		{
			float setDist = 600;
			float newDist = 0;
