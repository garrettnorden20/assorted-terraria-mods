...
{
	public class PoisonPipe : ModItem
	{
		public override string Texture => "Terraria/Item_" + ItemID.Blowpipe;
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Converts darts to poison darts.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.UseSound = SoundID.Item64; // The sound that this item plays when used.
		...
		{
			if (type == mod.ProjectileType("DartProjectile")) // or ProjectileID.WoodenArrowFriendly
			{
				type = ProjectileID.PoisonDartBlowgun; // or ProjectileID.FireArrow;
			}
