...
{
    class LaserGun : ModItem
    {
		public override string Texture => "Terraria/Item_" + ItemID.Xenopopper;
		...
		public override void SetDefaults()
		{
			...
			item.shoot = mod.ProjectileType("LaserGunProjectile2");
	...
	public class LaserGunProjectile2 : ModProjectile
    {
